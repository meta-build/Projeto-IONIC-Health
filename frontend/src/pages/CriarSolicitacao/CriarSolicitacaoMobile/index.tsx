import styles from './CriarSolicitacaoMobile.module.scss';
...
export default function CriarSolicitacaoMobile() {
  ...
  return (
    <section id='mobile' className={styles.container}>
      ...
      onClick={() => nav(-1)} >
        <GoogleIcon className={styles['voltar-icon']}>&#xe5cb;</GoogleIcon>
        <span>Voltar</span>
      </button>
      <Header36
        className={styles.hd}>
      ...
      <form
        ...
        <div>
          {/* botão não tem onclick, pois o submit já faz toda a ação de enviar o formulário. a função chamada está no onsubmit, no começo da tag form */}
            {erro &&
              <span className={styles['erro-message']}>
                Campos incompletos
              </span>}
          <div
